...
- schedule_job:   {"type":"schedule_job","customer":"","date":"YYYY-MM-DD","crew":""}  (set a job's scheduled date; Klyfton never books Sundays)
- mark_invoice_paid: {"type":"mark_invoice_paid","customer":"","invoiceNum":""}  (flag an invoice as paid; owner confirms)
- create_review_request: {"type":"create_review_request","customer":"","phone":""}  (draft a review request text to send after job completion)
