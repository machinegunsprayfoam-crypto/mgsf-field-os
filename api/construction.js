...
const ENGINES = {
  ...
  "concrete-flatwork": ["flatwork-calc", "sub-bid"],
  "roofing-shingle": ["roofing-shingle-calc", "sub-bid"],
  "masonry": ["masonry-calc", "sub-bid"],
  "excavation": ["excavation-calc", "sub-bid"],
  "sitework": ["sitework-calc", "sub-bid"],
};
